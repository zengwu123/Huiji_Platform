      ...
      <div class="span12">  
				...
				<div class="widget-box"> 
					<div class="widget-title">
						...
						<h5>资源列表</h5>
						<a href="${pageContext.request.contextPath}/resource/forAddResource.action" class="badge badge-success">添加角色</a>
					</div>
								...
								<tbody>
									<c:forEach items="${list }" var="list">
										<tr>
											...
											<td>
											<a class="badge badge-warning" href="${pageContext.request.contextPath }/resource/forUpdByResourceid.action?resource_id=${list.resource_id}">修改</a>
											</td>
											<td>
											<a class="badge badge-important" onclick="if(confirm('是否确定删除？')==false)return false;" href="${pageContext.request.contextPath }/resource/delResource.action?resource_id=${list.resource_id}">删除</a>
											</td>
										</tr>
									</c:forEach>
