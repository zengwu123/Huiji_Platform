    ...
    <div class="row-fluid">
      <div class="span12">
          ...
          <div class="widget-content"> <a href="#myModal" data-toggle="modal" class="btn btn-success">View Popup</a> <a href="#myAlert" data-toggle="modal" class="btn btn-warning">Alert</a> <a href="#myModal2" data-toggle="modal" class="btn btn-info">image Popup</a>
            <div id="myModal" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">脳</button>
                <h3>Pop up Header</h3>
              </div>
              <div class="modal-body">
                <p>Here is the text coming you can put also image if you want鈥?/p>
              </div>
            </div>
            <div id="myModal2" class="modal hide">
              ...
              <div class="modal-body">
                <p><img src="images/gallery/imgbox3.html"/></p>
              </div>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="alert alert-block"> <a class="close" data-dismiss="alert" href="#">脳</a>
            ...
            <div class="alert alert-success alert-block"> <a class="close" data-dismiss="alert" href="#">脳</a>
            ...
            <div class="alert alert-info alert-block"> <a class="close" data-dismiss="alert" href="#">脳</a>
              <h4 class="alert-heading">Info!</h4>
              Tou're not looking too good. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. </div>
            <div class="alert alert-error alert-block"> <a class="close" data-dismiss="alert" href="#">脳</a>
              <h4 class="alert-heading">Error!</h4>
              You're not looking too good. Nulla vitae elit libero, a pharetra augue. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. </div>
            <div class="alert">
              <button class="close" data-dismiss="alert">脳</button>
