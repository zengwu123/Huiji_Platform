					...
					<form id="loginForm" action="${pageContext.request.contextPath}/user_login.action"  method="post" novalidate="novalidate">
						<table>
							...
							<tr>
								...
								<td>
									<input type="password" id="password" name="password" class="text" maxlength="40" autocomplete="off">
								</td>
							</tr>
								<tr>
									<th>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="40" autocomplete="off"><img id="captchaImage" onclick="change()" class="captchaImage" src="${pageContext.request.contextPath}/checkImage.action" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
